...
export const ABOUT_PHILOSOPHY = [
  {
    ...
    description:
      "Fahad's eight-plus years as an entrepreneur have centered on building businesses that create lasting, meaningful impact — not just short-term returns.",
  },
  {
    title: "Transparent Ownership",
    description:
      "Serene Heights was built around a simple promise: zero maintenance charges, zero hidden costs. What you own is what you own — nothing more to pay for later.",
  },
  {
