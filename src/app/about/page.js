...
function AboutPage() {
  return (
    <div className="h-full" id="about">
      <div className="text-center px-6 md:px-16 lg:px-36 pt-16 sm:pt-24">
        <div className="max-w-7xl mx-auto">
          <h1 className="sm:text-5xl text-4xl font-bold text-[#37584F] gravesendSans text-left">
            About Serene Heights Nathia Gali
          </h1>

          <MagazineSection label={ABOUT_INTRO.heading} className="mt-14 sm:mt-20 pb-10">
            ...
            <div className="border-l border-[#37584F]/40 pl-5 mt-10">
              <p className="text-xl sm:text-2xl font-bold text-[#37584F] gravesendSans">
                {ABOUT_INTRO.attribution.name}
              </p>
              <p className="text-base sm:text-lg text-[#222]/70 inter mt-2">
                {ABOUT_INTRO.attribution.title}
              </p>
            </div>
          </MagazineSection>
        </div>
      ...
      <LocationSection className="mt-16 sm:mt-24" />

      <div className="text-center px-6 md:px-16 lg:px-36">
        <MagazineSection
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mt-10">
            {ABOUT_PROJECT.stats.map((stat) => (
              <div
                key={stat.label}
                className="text-left border-l border-[#37584F]/30 pl-4 py-1"
              >
                <p className="text-2xl sm:text-3xl font-bold text-[#37584F] gravesendSans">
                  {stat.value}
                </p>
                <p className="text-sm sm:text-base text-[#222]/70 inter mt-1">
                  {stat.label}
                </p>
              </div>
            ))}
        ...
        <div className="sm:pb-32 pb-20 flex flex-col md:flex-row gap-12 justify-center sm:justify-between items-center">
          <div className="w-full md:w-1/2 grid grid-cols-2 gap-2 mx-auto">
            <div>
              <div className="mb-2">
                <Image
